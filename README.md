...
Your assigned company: Citigroup (C), CIK 0000831001.

Fetch https://data.sec.gov/api/xbrl/companyconcept/CIK0000831001/dei/EntityCommonStockSharesOutstanding.json (set a descriptive User-Agent per SEC guidance).
...
`{"entityName": "Citigroup", "max": {"val": ..., "fy": ...}, "min": {"val": ..., "fy": ...}}`
...
**Generated:** 2025-10-22 12:48:07 UTC
